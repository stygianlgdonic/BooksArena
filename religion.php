...
<head>
    ...
    <title>Books Arena | Religion and Spirituality</title>
</head>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <img src="images/religion.jpg" width="100%">
                <div class="centered" style="font-family: 'Dynalight';font-size: 80px; text-align: center; color: white;    text-shadow: 2px 2px 4px #817d7d;
        ...
        <div class="row booksdisplay">
            ...
            <div class="col-md-10">
                <div class="row margin-tb">
                    ...
                    $query = "SELECT * FROM `books` WHERE `catagory` = 'religion'";
                        ...
                        <div class="row wide">
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <div class="col-md-4 margin-tb">
                                    ...
                                    <div class="row">
                                        <a href="religion.php?title=<?php echo $row[1];?>&price=<?php echo $row[6];?>&click=1" class="btn fas fa-cart-plus" style="color:red;"> Add To Cart</a>
                                    </div>
                                </div>
