...
<head>
    ...
    <title>Books Arena | Classics & Literature</title>
</head>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="centered" style=" text-shadow: 2px 2px 4px #817d7d; font-family: 'Dynalight';font-size: 80px; text-align: center;  color: white;">
                    Classics &
                    Literature</div>
            </div>
        </div>
