...
<head>
    ...
    <title>Books Arena | Biographies & Memoirs</title>
</head>
...
<body>
    ...
    <div class=" container-fluid">
        <div class="row">
            <div class="col-md-12">
                <img src="images/biomem.jpg" width="100%">
                <h1 style="font-family: 'Dynalight';font-size: 50px; text-align: center; text-shadow: 2px 2px 4px #000000 ">
                    Biographies & Memoirs</h1>
            </div>
        </div>
        <div class="row booksdisplay">
            ...
            <div class="col-md-10">
                <div class="row margin-tb">
                    ...
                    $query = "SELECT * FROM `books` WHERE `catagory` = 'biographies'";
                        ...
                        <div class="row wide">
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <div class="col-md-4 margin-tb">
                                    ...
                                    <div class="row">
                                        <a href="Biographyandmemoir.php?title=<?php echo $row[1];?>&price=<?php echo $row[6];?>&click=1" class="btn fas fa-cart-plus" style="color:red;"> Add To Cart</a>
                                    </div>
                                </div>
