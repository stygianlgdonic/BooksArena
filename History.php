...
<head>
    ...
    <title>Books Arena | History</title>
</head>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="centered" style="font-family: 'Dynalight';font-size: 80px; text-align: center; ">History
                </div>
            </div>
        </div>
                        ...
                        <div class="row wide">
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <div class="col-md-4 margin-tb">
                                    ...
                                    <div class="row">
                                        <a href="History.php?title=<?php echo $row[1];?>&price=<?php echo $row[6];?>&click=1" class="btn fas fa-cart-plus" style="color:red;"> Add To Cart</a>
                                    </div>
                                </div>
