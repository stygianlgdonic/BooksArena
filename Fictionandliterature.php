...
<head>
    ...
    <title>Books Arena | Fiction & Literature</title>
</head>
...
<nav class="navbar navbar-expand-lg navbar-dark navbar-fixed-top" style="background-color:rgb(35, 115, 168)">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <img src="images/art.jpg" width="100%">
                <div class="centered" style="font-family: 'Dynalight';font-size: 80px; text-align: center; text-shadow: 2px 2px 4px #000000 ">
                    Fiction &
                    Literature</div>
            </div>
        </div>
        <div class="row booksdisplay">
            ...
            <div class="col-md-10">
                <div class="row margin-tb">
                    ...
                    $query = "SELECT * FROM `books` WHERE `catagory` = 'fiction'";
                        ...
                        <div class="row wide">
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <div class="col-md-4 margin-tb">
                                    ...
                                    <div class="row">
                                        <a href="Fictionandliterature.php?title=<?php echo $row[1];?>&price=<?php echo $row[6];?>&click=1" class="btn fas fa-cart-plus" style="color:red;"> Add To Cart</a>
                                    </div>
                                </div>
